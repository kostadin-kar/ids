...
from numpy import (array, unravel_index, nditer, linalg, random, subtract, max,
                   power, exp, zeros, arange, outer, meshgrid, dot,
...
def _build_iteration_indexes(data_len, num_iterations,
                             verbose=False, random_generator=None): #USED
...
class MiniSom(object):
    ...
    def _check_iteration_number(self, num_iteration): #USED
        if num_iteration < 1:
            raise ValueError('num_iteration must be > 1')

    def _check_input_len(self, data): #USED
    ...
    def winner(self, x): #USED
        """Computes the coordinates of the winning neuron for the sample x."""
        self._activate(x)
        return unravel_index(self._activation_map.argmin(),
                             self._activation_map.shape)

    def update(self, x, win, t, max_iteration): #USED
    ...
    def train(self, data, num_iteration, random_order=False, verbose=False): #USED
        """Trains the SOM.
    ...
    def quantization_error(self, data): #USED
